...
const SignUpForm = () => {
  const { googleLogin, register } = useAuthContext();
      ...
      <div className="flex flex-col gap-6">
        <Card>
          <CardHeader className="text-center">
            <CardTitle className="text-xl">Welcome to MemoPad</CardTitle>
                ...
                <div className="grid gap-6">
                  ...
                  <div className="grid gap-6">
                    ...
                    <Button type="submit" className="w-full" disabled={form.formState.isSubmitting}>
                      {form.formState.isSubmitting ? <Loader2Icon className="animate-spin" /> : 'Continue'}
                    </Button>
                  </div>
